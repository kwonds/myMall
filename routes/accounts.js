...
router.get('/join', function(req, res){
    res.render('accounts/join',{ title:'회원가입', bodyId:'join', js:'../../js/join.js'})
...
router.get('/login', function(req, res){
    res.render('accounts/login',{ title:'로그인', bodyId:'login', js:'../../js/login.js',flashMessage : req.flash().error})
